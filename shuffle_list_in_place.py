...
'''
Solution:
  I iterate through the input list and at each iteration I select randomly one index in the range(current_index, index_of_last_element_of_the_list). Then, I swap the element at current_index with the element at the randomly generated index.
