...
# returns True because only one letter ("k") has an odd number of occurrences.
my_string = "aabbc"
# returns False because more than one char ("c" and "d") have an odd number of occurrences.
my_string = "aabbcd"
